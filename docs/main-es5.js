...
var httpHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]({ 'Content-Type': 'application/json' });
var AppSettings = {
...
var TokenInterceptor = /** @class */ (function () {
    ...
    TokenInterceptor.prototype.intercept = function (req, next) {
        var authService = this.injector.get(_authentication_auth_service__WEBPACK_IMPORTED_MODULE_2__["AuthService"]);
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.ngOnInit = function () {
        ...
        this.formSubscription = this.form.valueChanges.subscribe(function () {
            _this.disableBtn = !_this.form.valid;
        });
    };
    ...
    LoginComponent.prototype.login = function () {
        this.disableBtn = true;
        this.authService.login(this.form.value).pipe().subscribe(function () {
...
var ArticleCardComponent = /** @class */ (function () {
    ...
    ArticleCardComponent.prototype.editArticle = function () {
        this.edit.emit(this.article);
    };
    ArticleCardComponent.prototype.deleteArticle = function () {
...
var ArticleFormComponent = /** @class */ (function () {
    ...
    ArticleFormComponent.prototype.ngOnInit = function () {
        ...
        this.formSubscription = this.form.valueChanges.subscribe(function () { return _this.disableBtn = !_this.form.valid; });
    };
    ArticleFormComponent.prototype.ngOnDestroy = function () {
        this.formSubscription.unsubscribe();
    };
    ArticleFormComponent.prototype.cancel = function () {
        this.close.emit();
    };
    ArticleFormComponent.prototype.submit = function () {
        this.output.emit(this.form.value);
    };
    ArticleFormComponent.prototype.patchForm = function () {
...
var ArticleDialogComponent = /** @class */ (function () {
    function ArticleDialogComponent(article, dialogRef, inventoryService) {
    ...
    ArticleDialogComponent.prototype.addArticle = function () {
        var _this = this;
        this.inventoryService.addArticle(this.formData).subscribe(function (newArticle) { return _this.dialogRef.close(newArticle); }, function (error) { return console.log(error); });
    };
    ArticleDialogComponent.prototype.close = function () {
        this.dialogRef.close();
    };
    ArticleDialogComponent.prototype.editArticle = function () {
        var _this = this;
        this.inventoryService.editArticle(this.article._id, this.formData).subscribe(function (editedArticle) { return _this.dialogRef.close(editedArticle); }, function (error) { return console.error(error); });
    };
    ArticleDialogComponent.prototype.submit = function (formData) {
        this.formData = formData;
        this.title === 'Agregar' ? this.addArticle() : this.editArticle();
    };
    ArticleDialogComponent.ctorParameters = function () { return [
...
var StockComponent = /** @class */ (function () {
    function StockComponent(changeDetectorRef, dialog, inventoryService, snackBar) {
    ...
    StockComponent.prototype.ngOnInit = function () {
        ...
        this.subscription = this.inventoryService.getArticles().subscribe(function (data) {
            _this.dataSource = new _angular_material__WEBPACK_IMPORTED_MODULE_3__["MatTableDataSource"](data);
            _this.changeDetectorRef.detectChanges();
            _this.dataSource.paginator = _this.paginator;
            _this.observable = _this.dataSource.connect();
        });
    };
    StockComponent.prototype.ngOnDestroy = function () {
        this.subscription.unsubscribe();
    };
    StockComponent.prototype.onResize = function (event) {
    ...
    StockComponent.prototype.addArticle = function () {
        var _this = this;
        var dialogRef = this.dialog.open(_dialogs_article_dialog_article_dialog_component__WEBPACK_IMPORTED_MODULE_4__["ArticleDialogComponent"], { disableClose: true });
        dialogRef.afterClosed().subscribe(function (newArticle) {
            if (newArticle) {
                _this.addToArray(newArticle);
            }
        });
    };
    StockComponent.prototype.addToArray = function (article) {
        var data = this.dataSource.data;
        data.push(article);
        this.dataSource.data = data;
        this.snackBar.open('Se agregó el artículo correctamente.', 'OK', { verticalPosition: 'top' });
    };
    StockComponent.prototype.editArticle = function (article) {
        var _this = this;
        var dialogRef = this.dialog.open(_dialogs_article_dialog_article_dialog_component__WEBPACK_IMPORTED_MODULE_4__["ArticleDialogComponent"], { data: article, disableClose: true });
        dialogRef.afterClosed().subscribe(function (editedArticle) {
            if (editedArticle) {
                _this.updateFromArray(editedArticle);
            }
        }, function (error) { return console.error(error); });
    };
    StockComponent.prototype.deleteArticle = function (_id) {
        var _this = this;
        var dialogRef = this.dialog.open(_shared_warning_dialog_warning_dialog_component__WEBPACK_IMPORTED_MODULE_5__["WarningDialogComponent"], { data: { title: '¿Seguro que desea eliminar el artículó?', description: 'Esta acción no se puede deshacer.' } });
        dialogRef.afterClosed().subscribe(function (answer) {
            if (answer) {
                _this.inventoryService.deleteArticle(_id).subscribe(function () { return _this.removeFromArray(_id); }, function (error) { return console.error(error); });
            }
        });
    };
    StockComponent.prototype.removeFromArray = function (_id) {
        this.dataSource.data = this.dataSource.data.filter(function (article) { return article._id !== _id; });
        this.snackBar.open('Se eliminó el artículo correctamente.', 'OK', { verticalPosition: 'top' });
    };
    StockComponent.prototype.updateFromArray = function (article) {
        var _this = this;
        this.dataSource.data.forEach(function (element) {
            if (element._id === article._id) {
                element = article;
                _this.snackBar.open('Se editó el artículo correctamente.', 'OK', { verticalPosition: 'top' });
            }
        });
    };
...
var InventoryService = /** @class */ (function () {
    function InventoryService(httpClient) {
        this.httpClient = httpClient;
    ...
    InventoryService.prototype.getArticles = function (_id) {
        if (_id) {
    ...
    InventoryService.prototype.addArticle = function (article) {
        return this.httpClient.post(this.endpoint, article, { headers: this.httpHeaders });
    };
    InventoryService.prototype.editArticle = function (_id, article) {
        console.log('Editar');
        return this.httpClient.put(this.endpoint + "?_id=" + _id.$oid, article, { headers: this.httpHeaders });
    };
    InventoryService.prototype.deleteArticle = function (_id) {
...
var WarningDialogComponent = /** @class */ (function () {
    function WarningDialogComponent(data, dialogRef) {
        this.data = data;
        this.dialogRef = dialogRef;
    }
    WarningDialogComponent.prototype.ngOnInit = function () {
    };
    WarningDialogComponent.prototype.close = function (answer) {
        this.dialogRef.close(answer);
    };
    WarningDialogComponent.ctorParameters = function () { return [
        { type: undefined, decorators: [{ type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["Inject"], args: [_angular_material__WEBPACK_IMPORTED_MODULE_2__["MAT_DIALOG_DATA"],] }] },
        { type: _angular_material__WEBPACK_IMPORTED_MODULE_2__["MatDialogRef"] }
    ]; };
